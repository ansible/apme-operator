...
import (
	...
	"github.com/ansible/apme-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(apmev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b760e4bf.ansible.com",
	...
	if err := (&controller.ApmeReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Apme")
		os.Exit(1)
	}
